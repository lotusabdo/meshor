                    ...
                    try:
                       ...
                       if invitelink is None:
                        ...
                        try:
                          ...
                          await client.send_message(chat_id, f"** حدث خطأ حاول مرا آخري لاحقا**\n**{GROUP} : او تواصل مع الدعم من هنا .⚡**", reply_to_message_id=message_id)
                    m = await client.send_message(chat_id, "**انتظر قليلاً جࢪي تفعيل البوت .⚡**")
                    if invitelink.startswith("https://t.me/+"):
                        invitelink = invitelink.replace("https://t.me/+", "https://t.me/joinchat/")
                    await userbot.join_chat(invitelink)
                    join = True
...
async def aii(client: Client, message):
   ...
   try:
    ...
    rep = await message.reply_text("**جاࢪي اختيار تشغيل عشوائي ♻️**")
    try:
          call = await get_call(bot_username)
    except:
  ...
  if not message.reply_to_message:
     ...
     await rep.delete()
       ...
       if not message.reply_to_message.media:
         return
       rep = await message.reply_text("**جاࢪي تشغيل الملف انتظر قليلا 🚦 .**") 
       photo = "Uploaded to https://telegra.ph/file/8723a6f9792a2ab44ec2f.jpg"
