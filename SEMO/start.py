...
async def welcome(client: Client, message):
   try:
    ...
    if message.new_chat_members[0].username == "EU_TM":
      try:
        ...
        pass
      return await message.reply_text(f"**• انضم المطو لوتسللشات  ⚡ .\n• مرحبا بك : @EU_TM  ⚡ .**")
    dev = await get_dev(bot_username)
...
"مره واحد اسمو لوتس كان بيرجم ابليس ف الحج قالولو ليه؟ قال عشان يمكن احتاجو 👻😹",
...
async def alive(client: Client, message):
    ...
    alive = f"""╭──── • ◈ • ────╮
么 [𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙰𝙱𝙾𝙾𝚂](t.me/l2_2Y) ⚡ .
么  [𝙳𝙴𝚅 𝙺𝙰𝙱𝙾𝙾𝚂](t.me/EU_TM) ⚡ .
╰──── • ◈ • ────╯
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton("𖥻 𝐔𝐑 , 𝐅𝐚𝐕 𝐀𝐛𝐃𝐎𝐨 -", user_id=f"ahmedelnqyb")
                        ],
                        [
...
@Client.on_message(filters.command(["المبرمج","عبدو  ","المطور السورس "], ""))
...
async def llink(client: Client, message: Message):
    if not message.from_user.username in ["EU_TM"]:
      return
...
async def tiillli(client, message):
  if message.from_user.username in ["EU_TM"]:
   ...
   if message.from_user.username == "EU_TM":
     await message.reply_text(f"**• تم تنفيذ الامر بواسطة المطور لوتس ⚡ .**")
   else:
...
async def sssora(client, message):
  ...
  await message.reply_photo(photo=photo, caption="**• 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ➧ @l2_2Y  ⚡ .**")
...
async def voece(client, message):
  ...
  await message.reply_audio(audio=audio, caption="**• 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ➧ @l2_2Y  ⚡ .**")
...
async def videoo(client, message):
  ...
  await message.reply_video(video=video, caption="**• 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ➧ @l2_2Y  ⚡ .**")
...
async def bt(client: Client, message: Message):
  try:
     ...
     if userr.username in ["EU_TM"]:
         await message.reply_text("**• رتبتك هي : المطور لوتس ⚡ .**")
         return
     if userr.username in ["EU_TM"]:
         await message.reply_text("**• رتبتك هي : المطور لوتس⚡ .**")
         return
